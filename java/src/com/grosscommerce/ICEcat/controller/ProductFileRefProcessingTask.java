...
public class ProductFileRefProcessingTask extends QueueProcessorTask<ProductFileRef>
{
    ...
    {
        ParsedProductInfo importTaskItem = new ParsedProductInfo(object,
                                                                 this.language);
        ...
        try
        {
            importTaskItem.setProduct(ResourcesDownloader.downloadProduct(
                    ...
                    this.userName,
                    this.password));
            importTaskItem.setParsingStatus(
                    ParsedProductInfo.ParsingStatus.Success);
        }
        catch (Throwable ex)
        {
            importTaskItem.setParsingStatus(
                    ParsedProductInfo.ParsingStatus.Failure);
