...
public abstract class XmlObjectBase implements IXmlObject
{
    ...
    protected abstract boolean parseFromElementInternal(
            Element thisObjectElement);

    protected abstract void saveToElementInternal(Element parentElement);

    private void checkNodeName(Element thisObjectElement) throws
            IllegalArgumentException
    {
        if (!thisObjectElement.getNodeName().equals(this.getRootNodeName()))
        {
            throw new IllegalArgumentException(
                    "Error! Element name is not valid. Element name: " + thisObjectElement.
                    getNodeName() + " != " + this.getRootNodeName());
        }
    }
    ...
    // </editor-fold>
    private boolean parseField(Field field, Element thisObjectElement) throws
    ...
    {
        Element thisObjectElement = parentElement.getOwnerDocument().
                createElement(
    ...
    private boolean saveField(Field field, Element parentElement) throws
    ...
    public boolean saveLocalizedField(Field field, Element parentElement) throws
            IllegalArgumentException, IllegalAccessException
    {
        ...
        for (Integer key : values.keySet())
        {
            ...
            XmlUtil.appendStringAttribute(elem, xmlProp.valueAttrName(), values.
                    get(
                    key));
